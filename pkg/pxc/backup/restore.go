...
func RestoreJob(cr *api.PerconaXtraDBClusterRestore, bcp *api.PerconaXtraDBClusterBackup, cluster *api.PerconaXtraDBCluster, destination api.PXCBackupDestination, scheme *runtime.Scheme, pitr bool) (*batchv1.Job, error) {
